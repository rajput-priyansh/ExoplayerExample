package com.vibs.previewseekbar;
...
import com.vibs.previewseekbar.animator.PreviewFadeAnimator;
import com.vibs.previewseekbar.animator.PreviewMorphAnimator;
...
public class PreviewDelegate {
    ...
    public void onScrubMove(int progress, boolean fromUser) {
        Log.d("TESTV", "onScrubMove() called with: progress = [" + progress + "], fromUser = [" + fromUser + "] previewViewAttached=" + previewViewAttached);
