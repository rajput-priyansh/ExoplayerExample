package com.vibs.previewseekbar.timebar;
...
import com.vibs.previewseekbar.PreviewDelegate;
import com.vibs.previewseekbar.PreviewLoader;
import com.vibs.previewseekbar.R;
import com.vibs.previewseekbar.animator.PreviewAnimator;
...
public class PreviewTimeBar extends DefaultTimeBar implements PreviewBar {
    ...
    public PreviewTimeBar(Context context, AttributeSet attrs) {
        ...
        previewId = typedArray.getResourceId(
                R.styleable.PreviewTimeBar_previewFrameLayoutTimeBar, View.NO_ID);

        delegate = new PreviewDelegate(this);
        delegate.setPreviewEnabled(isEnabled());
        delegate.setAnimationEnabled(typedArray.getBoolean(
                R.styleable.PreviewTimeBar_previewAnimationEnabledTimeBar, true));
        delegate.setPreviewEnabled(typedArray.getBoolean(
                R.styleable.PreviewTimeBar_previewEnabledTimeBar, true));
        delegate.setAutoHidePreview(typedArray.getBoolean(
                R.styleable.PreviewTimeBar_previewAutoHideTimeBar, true));
