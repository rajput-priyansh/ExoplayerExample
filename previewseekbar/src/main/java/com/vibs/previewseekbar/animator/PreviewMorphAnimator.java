package com.vibs.previewseekbar.animator;
...
public class PreviewMorphAnimator implements PreviewAnimator {
    ...
    private static int MORPH_SHOW_DURATION = 125;
    private static int MORPH_HIDE_DURATION = 125;
    private static int TRANSLATION_SHOW_DURATION = 100;
    private static int TRANSLATION_HIDE_DURATION = 100;
